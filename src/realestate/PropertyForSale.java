...
public class PropertyForSale
{
  ...
  public PropertyForSale(int aListingNumber, int aAskingPrice, Date aDateListedForSale, Property aListedProperty)
  {
    ...
    {
      throw new RuntimeException("Unable to create propertyForSale due to listedProperty. See http://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  ...
  public void delete()
  {
    ...
    if(placeholderListedProperty != null)
    {
